...
LiquidPlanner.projects      = resource(':host/:api_path/workspaces/:space_id/projects/');
LiquidPlanner.treeitems      = resource(':host/:api_path/workspaces/:space_id/treeitems/');
LiquidPlanner.timesheets      = resource(':host/:api_path/workspaces/:space_id/timesheet_entries?start_date=' + d1);
LiquidPlanner.project       = resource(':host/:api_path/workspaces/:space_id/projects/:project_id');
...
LiquidPlanner.tracktimeUrl	 = ':host/:api_path/workspaces/:space_id/tasks/:task_id/track_time';
